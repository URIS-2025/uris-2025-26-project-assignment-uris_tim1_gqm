    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_organization_roles", x => new { x.user_id, x.role_id, x.organization_id });
                    table.ForeignKey(
                        name: "FK_user_organization_roles_roles_role_id",
                        column: x => x.role_id,
                        principalTable: "roles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_organization_roles_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_organization_roles_role_id",
                table: "user_organization_roles",
                column: "role_id");
